...
import ResultM2 from "./ResultM2";

export default function Questionbox2(props) {
  /* onst [data, setData] = useState([]); */
  /* onst [data1, setData1] = useState([]); */
  ...
  const scoreRedOrange = parseInt(scoreRed2) + parseInt(scoreOrange2);
  ...
  return (
    <Grid container xs={12} className="gidM">
      {collection[2] == "orange" ? (
        ...
        >
          <Two2 data1={data1} zone={green} collection={collection} />
        </Paper>
      ) : collection[2] == null ? (
        <Paper
          elevation={12}
          ...
          style={{ borderRadius: "16px" }}
        >
          <One2 data={data} zone={orange} collection={collection} />
        </Paper>
      ) : collection[2] == "green" && scoreRedOrange > (30 / 100) * 70 ? (
        <Paper
          elevation={12}
          className="qcard"
          style={{ borderRadius: "16px" }}
        >
          <Three2 data={data} data1={data1} collection={collection} />
        </Paper>
      ) : (
        <ResultM2 />
      )}
